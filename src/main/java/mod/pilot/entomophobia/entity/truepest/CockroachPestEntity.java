...
public class CockroachPestEntity extends PestBase {
    public CockroachPestEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    protected void registerBasicGoals() {
        ...
        this.goalSelector.addGoal(3, new HomophobicRandomStrollGoal(this, 1, 40, 48, 16));
