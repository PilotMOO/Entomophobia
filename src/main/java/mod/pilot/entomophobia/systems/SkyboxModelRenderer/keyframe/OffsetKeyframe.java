...
public class OffsetKeyframe extends RenderPackageKeyframe{
    public double x, y, z;
    ...
    public OffsetKeyframe(Vec3 position, float duration){
        this(position.x, position.y, position.z, duration);
    }
    public OffsetKeyframe(double x, double y, double z, float duration){
    ...
    public void step(RenderPackage _package) {
        _package.offset(lerpVectors(_package.offset, getAsVector(), partial));
