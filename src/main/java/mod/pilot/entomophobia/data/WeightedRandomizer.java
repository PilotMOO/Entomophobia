...
public class WeightedRandomizer<T> extends ArrayList<T> {
    ...
    /**The default weight assigned to any untagged BlockStates, assign it in the constructor or via {@code AdjustWeight(int, boolean)}*/
     ...
     * @param newWeights a Collection of weights to assign to the new entries
     */
